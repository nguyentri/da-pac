...
impl RfptAddrReg {
    ...
    pub fn rfpt_addr(
        self,
    ) -> crate::common::RegisterField<2, 0x3fff, 1, 0, u16, RfptAddrReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<2,0x3fff,1,0,u16, RfptAddrReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl RfptLenReg {
    ...
    pub fn rfpt_len(
        self,
    ) -> crate::common::RegisterField<0, 0x3fff, 1, 0, u16, RfptLenReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0x3fff,1,0,u16, RfptLenReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
