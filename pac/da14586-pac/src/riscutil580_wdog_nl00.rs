...
#[allow(unused_imports)]
use crate::common::*;
#[doc = r"riscutil580_wdog_nl00 registers"]
unsafe impl ::core::marker::Send for super::Riscutil580WdogNl00 {}
unsafe impl ::core::marker::Sync for super::Riscutil580WdogNl00 {}
impl super::Riscutil580WdogNl00 {
    #[allow(unused)]
    #[inline(always)]
...
impl WatchdogReg {
    ...
    pub fn wdog_wen(
        self,
    ) -> crate::common::RegisterField<9, 0x7f, 1, 0, u8, u8, WatchdogReg_SPEC, crate::common::W>
    {
    ...
    pub fn wdog_val(
        self,
    ) -> crate::common::RegisterField<0, 0xff, 1, 0, u8, u8, WatchdogReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0xff,1,0,u8,u8,WatchdogReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
