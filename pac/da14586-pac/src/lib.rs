...
#![doc = "Ultra-Low power Bleutooth 5.0 SoC with audio interface and 2 Mbit flash from Dialog Semiconductor"]
pub mod common;
pub use common::*;
...
#[cfg(feature = "ambacore580_patch_gr00")]
pub mod ambacore580_patch_gr00;
...
#[cfg(feature = "r_rfcu580_nl01")]
pub mod r_rfcu580_nl01;
#[cfg(feature = "rfpt580_gr01")]
pub mod rfpt580_gr01;
...
#[cfg(feature = "ambacore580_patch_gr00")]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Ambacore580PatchGr00 {
    ptr: *mut u8,
}
#[cfg(feature = "ambacore580_patch_gr00")]
pub const AMBACORE580_PATCH_GR00: self::Ambacore580PatchGr00 = self::Ambacore580PatchGr00 {
    ptr: 0x40008400u32 as _,
};
#[cfg(feature = "anamisc580_nl01")]
#[derive(Copy, Clone, Eq, PartialEq)]
...
#[cfg(feature = "r_rfcu580_nl01")]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct RRfcu580Nl01 {
    ptr: *mut u8,
}
#[cfg(feature = "r_rfcu580_nl01")]
pub const R_RFCU580_NL01: self::RRfcu580Nl01 = self::RRfcu580Nl01 {
    ptr: 0x50002000u32 as _,
};
#[cfg(feature = "rfpt580_gr01")]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Rfpt580Gr01 {
    ptr: *mut u8,
}
#[cfg(feature = "rfpt580_gr01")]
pub const RFPT580_GR01: self::Rfpt580Gr01 = self::Rfpt580Gr01 {
...
pub struct Peripherals {
    ...
    #[cfg(feature = "ambacore580_patch_gr00")]
    pub AMBACORE580_PATCH_GR00: self::Ambacore580PatchGr00,
    #[cfg(feature = "anamisc580_nl01")]
    ...
    #[cfg(feature = "r_rfcu580_nl01")]
    pub R_RFCU580_NL01: self::RRfcu580Nl01,
    #[cfg(feature = "rfpt580_gr01")]
    pub RFPT580_GR01: self::Rfpt580Gr01,
    #[cfg(feature = "riscutil580_gpreg_nl01")]
...
impl Peripherals {
    ...
    pub fn steal() -> Self {
        Peripherals {
            ...
            #[cfg(feature = "ambacore580_patch_gr00")]
            AMBACORE580_PATCH_GR00: crate::AMBACORE580_PATCH_GR00,
            #[cfg(feature = "anamisc580_nl01")]
            ...
            #[cfg(feature = "r_rfcu580_nl01")]
            R_RFCU580_NL01: crate::R_RFCU580_NL01,
            #[cfg(feature = "rfpt580_gr01")]
            RFPT580_GR01: crate::RFPT580_GR01,
            #[cfg(feature = "riscutil580_gpreg_nl01")]
