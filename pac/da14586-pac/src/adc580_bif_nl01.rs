...
impl GpAdcCtrlReg {
    ...
    pub fn gp_adc_sel(
        self,
    ) -> crate::common::RegisterField<6, 0xf, 1, 0, u8, GpAdcCtrlReg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<6,0xf,1,0,u8, GpAdcCtrlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
...
impl GpAdcDelay2Reg {
    ...
    pub fn del_adc_start(
        self,
    ) -> crate::common::RegisterField<8, 0xff, 1, 0, u8, GpAdcDelay2Reg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<8,0xff,1,0,u8, GpAdcDelay2Reg_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn del_adc_en(
        self,
    ) -> crate::common::RegisterField<0, 0xff, 1, 0, u8, GpAdcDelay2Reg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0xff,1,0,u8, GpAdcDelay2Reg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl GpAdcDelayReg {
    ...
    pub fn del_ldo_en(
        self,
    ) -> crate::common::RegisterField<0, 0xff, 1, 0, u8, GpAdcDelayReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0xff,1,0,u8, GpAdcDelayReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl GpAdcResultReg {
    ...
    pub fn gp_adc_val(
        self,
    ) -> crate::common::RegisterField<0, 0x3ff, 1, 0, u16, GpAdcResultReg_SPEC, crate::common::R>
    {
        crate::common::RegisterField::<0,0x3ff,1,0,u16, GpAdcResultReg_SPEC,crate::common::R>::from_register(self,0)
    }
}
