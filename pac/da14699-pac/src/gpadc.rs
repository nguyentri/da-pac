...
impl GpAdcCtrlReg {
    ...
    pub fn gp_adc_diff_temp_sel(
        self,
    ) -> crate::common::RegisterField<16, 0x3, 1, 0, u8, GpAdcCtrlReg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<16,0x3,1,0,u8, GpAdcCtrlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
