...
impl UartCtrReg {
    ...
    pub fn uart_ctr(
        self,
    ) -> crate::common::RegisterField<0, 0xffffffff, 1, 0, u32, UartCtrReg_SPEC, crate::common::R>
    {
        crate::common::RegisterField::<0,0xffffffff,1,0,u32, UartCtrReg_SPEC,crate::common::R>::from_register(self,0)
    }
}
...
impl UartIerDlhReg {
    ...
    pub fn dlh6_5(
        self,
    ) -> crate::common::RegisterField<5, 0x3, 1, 0, u8, UartIerDlhReg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<5,0x3,1,0,u8, UartIerDlhReg_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Interrupt Enable Register: (read only) ELCOLR, this bit controls the method for clearing the status in the LSR register. This is applicable only for Overrun Error, Parity Error, Framing Error, and Break Interrupt status bits.\nAlways 0 = LSR status bits are cleared either on reading Rx FIFO (RBR Read) or On reading LSR register.\nDivisor Latch (High): Bit\\[4\\] of the 8 bit DLH register"]
    #[inline(always)]
    pub fn elcolr_dlh4(
        self,
...
impl UartIirFcrReg {
    ...
    pub fn iir_fcr(
        self,
    ) -> crate::common::RegisterField<0, 0xff, 1, 0, u8, UartIirFcrReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0xff,1,0,u8, UartIirFcrReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl UartUcvReg {
    ...
    pub fn uart_ucv(
        self,
    ) -> crate::common::RegisterField<0, 0xffffffff, 1, 0, u32, UartUcvReg_SPEC, crate::common::R>
    {
        crate::common::RegisterField::<0,0xffffffff,1,0,u32, UartUcvReg_SPEC,crate::common::R>::from_register(self,0)
    }
}
