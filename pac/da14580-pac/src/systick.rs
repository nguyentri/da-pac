...
impl Load {
    ...
    pub fn reload(
        self,
    ) -> crate::common::RegisterField<0, 0xffffff, 1, 0, u32, Load_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0xffffff,1,0,u32, Load_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl Val {
    ...
    pub fn current(
        self,
    ) -> crate::common::RegisterField<0, 0xffffff, 1, 0, u32, Val_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0xffffff,1,0,u32, Val_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl Calib {
    ...
    pub fn tenms(
        self,
    ) -> crate::common::RegisterField<0, 0xffffff, 1, 0, u32, Calib_SPEC, crate::common::R> {
        crate::common::RegisterField::<0,0xffffff,1,0,u32, Calib_SPEC,crate::common::R>::from_register(self,0)
    }
