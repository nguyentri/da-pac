...
impl CoexDiagReg {
    ...
    pub fn coex_diag_mon(
        self,
    ) -> crate::common::RegisterField<0, 0xffff, 1, 0, u16, CoexDiagReg_SPEC, crate::common::R>
    {
        crate::common::RegisterField::<0,0xffff,1,0,u16, CoexDiagReg_SPEC,crate::common::R>::from_register(self,0)
    }
}
...
impl CoexPri16Reg {
    ...
    pub fn coex_pri_mac(
        self,
    ) -> crate::common::RegisterField<3, 0x3, 1, 0, u8, CoexPri16Reg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<3,0x3,1,0,u8, CoexPri16Reg_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Refer to COEX_PRI1_REG."]
    #[inline(always)]
    pub fn coex_pri_pti(
        self,
    ) -> crate::common::RegisterField<0, 0x7, 1, 0, u8, CoexPri16Reg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0x7,1,0,u8, CoexPri16Reg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl CoexPri17Reg {
    ...
    pub fn coex_pri_mac(
        self,
    ) -> crate::common::RegisterField<3, 0x3, 1, 0, u8, CoexPri17Reg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<3,0x3,1,0,u8, CoexPri17Reg_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Refer to COEX_PRI1_REG."]
    #[inline(always)]
    pub fn coex_pri_pti(
        self,
    ) -> crate::common::RegisterField<0, 0x7, 1, 0, u8, CoexPri17Reg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0x7,1,0,u8, CoexPri17Reg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl CoexStatReg {
    ...
    pub fn coex_decision_ptr(
        self,
    ) -> crate::common::RegisterField<0, 0x1f, 1, 0, u8, CoexStatReg_SPEC, crate::common::R> {
        crate::common::RegisterField::<0,0x1f,1,0,u8, CoexStatReg_SPEC,crate::common::R>::from_register(self,0)
    }
}
