...
impl UartIirFcrReg {
    ...
    pub fn iir_fcr(
        self,
    ) -> crate::common::RegisterField<0, 0xffff, 1, 0, u16, UartIirFcrReg_SPEC, crate::common::R>
    {
        crate::common::RegisterField::<0,0xffff,1,0,u16, UartIirFcrReg_SPEC,crate::common::R>::from_register(self,0)
    }
}
...
impl ::core::default::Default for UartUcvReg {
    ...
    fn default() -> UartUcvReg {
        <crate::RegValueT<UartUcvReg_SPEC> as RegisterValue<_>>::new(53556522)
    }
}
