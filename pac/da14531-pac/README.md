...
This is the Peripheral Access Crate (PAC) for the DA14531 device series.
...
The `da14531-pac` crate provides low-level access to device registers, enabling developers to interact with the hardware safely and efficiently.
