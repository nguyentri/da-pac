...
impl OtpcAhbadrReg {
    #[doc = "It is the AHB address used by the AHB master interface of the controller (the bits \\[15:2\\]). The bits \\[1:0\\] of the address are considered always as equal to zero.\nThe value of the register remains unchanged, by the internal logic of the controller."]
    #[inline(always)]
    pub fn otpc_ahbadr(
        self,
    ) -> crate::common::RegisterField<2, 0x3fff, 1, 0, u16, OtpcAhbadrReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<2,0x3fff,1,0,u16, OtpcAhbadrReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl OtpcCeladrReg {
    #[doc = "Defines a word address inside the OTP cell that will be used during the AREAD mode and the OTP mirroring."]
    #[inline(always)]
    pub fn otpc_celadr(
        self,
...
impl OtpcModeReg {
    #[doc = "Defines the part of the OTP cell that is programmed by the controller during the PROG mode, for each program request that is applied.\n0x0 : Both normal and redundancy arrays are programmed. This is the normal way of programming.\n0x1 : Only the normal array is programmed.\n0x2 : Only the redundancy array is programmed.\n0x3 : Reserved\nThe value of this configuration field can be modified only when the controller is in an inactive mode (DSTBY or STBY). The setting will take effect when will be enabled again the PROG mode."]
    #[inline(always)]
    pub fn otpc_mode_prg_sel(
        self,
    ) -> crate::common::RegisterField<6, 0x3, 1, 0, u8, OtpcModeReg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<6,0x3,1,0,u8, OtpcModeReg_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Defines the temperature condition under which is performed a margin read. It affects only the initial margin read (RINI mode) and the programming verification margin read (PVFY).\n0 : Regular temperature condition (less than 85°C)\n1 : High temperature condition (85°C or more)\nThe value of this configuration field can be modified only when the controller is in an inactive mode (DSTBY or STBY). The selection will take effect at the next PVFY or RINI mode that will be enabled. The READ mode is not affected by the setting of this configuration bit."]
    #[inline(always)]
    ...
    #[doc = "Selects the memory area of the OTP cell that will be used.\n0 - Uses the main memory area of the OTP cell\n1 - Uses the test row of the OTP cell\nThe value of this configuration field can be modified only when the controller is in an inactive mode (DSTBY or STBY). The selection will take effect at the next programming or reading mode that will be enabled."]
    #[inline(always)]
...
impl OtpcNwordsReg {
    #[doc = "The number of words (minus one) that will be copied by the AREAD mode. During mirroring, this register reflects the amount of data that will be copied."]
    #[inline(always)]
    pub fn otpc_nwords(
        self,
...
impl OtpcPaddrReg {
    ...
    pub fn otpc_paddr(
        self,
    ) -> crate::common::RegisterField<0, 0x1fff, 1, 0, u16, OtpcPaddrReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0x1fff,1,0,u16, OtpcPaddrReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl OtpcPwordReg {
    ...
    pub fn otpc_pword(
        self,
    ) -> crate::common::RegisterField<0, 0xffffffff, 1, 0, u32, OtpcPwordReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0xffffffff,1,0,u32, OtpcPwordReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl OtpcTim1Reg {
    ...
    pub fn otpc_tim1_us_t_csp(
        self,
    ) -> crate::common::RegisterField<24, 0x7f, 1, 0, u8, OtpcTim1Reg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<24,0x7f,1,0,u8, OtpcTim1Reg_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn otpc_tim1_us_t_cs(
        self,
    ) -> crate::common::RegisterField<20, 0xf, 1, 0, u8, OtpcTim1Reg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<20,0xf,1,0,u8, OtpcTim1Reg_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn otpc_tim1_us_t_pl(
        self,
    ) -> crate::common::RegisterField<16, 0xf, 1, 0, u8, OtpcTim1Reg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<16,0xf,1,0,u8, OtpcTim1Reg_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn otpc_tim1_cc_t_rd(
        self,
    ) -> crate::common::RegisterField<12, 0x7, 1, 0, u8, OtpcTim1Reg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<12,0x7,1,0,u8, OtpcTim1Reg_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn otpc_tim1_cc_t_20ns(
        self,
    ) -> crate::common::RegisterField<8, 0x3, 1, 0, u8, OtpcTim1Reg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<8,0x3,1,0,u8, OtpcTim1Reg_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn otpc_tim1_cc_t_1us(
        self,
    ) -> crate::common::RegisterField<0, 0x7f, 1, 0, u8, OtpcTim1Reg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0x7f,1,0,u8, OtpcTim1Reg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
impl ::core::default::Default for OtpcTim1Reg {
    #[inline(always)]
    fn default() -> OtpcTim1Reg {
        <crate::RegValueT<OtpcTim1Reg_SPEC> as RegisterValue<_>>::new(161021967)
    }
}
...
impl OtpcTim2Reg {
    ...
    pub fn otpc_tim2_us_t_sas(
        self,
    ) -> crate::common::RegisterField<29, 0x3, 1, 0, u8, OtpcTim2Reg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<29,0x3,1,0,u8, OtpcTim2Reg_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn otpc_tim2_us_t_pph(
        self,
    ) -> crate::common::RegisterField<24, 0x1f, 1, 0, u8, OtpcTim2Reg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<24,0x1f,1,0,u8, OtpcTim2Reg_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn otpc_tim2_us_t_vds(
        self,
    ) -> crate::common::RegisterField<21, 0x7, 1, 0, u8, OtpcTim2Reg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<21,0x7,1,0,u8, OtpcTim2Reg_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn otpc_tim2_us_t_pps(
        self,
    ) -> crate::common::RegisterField<16, 0x1f, 1, 0, u8, OtpcTim2Reg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<16,0x1f,1,0,u8, OtpcTim2Reg_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "The number of microseconds (minus one) for recovery after a programming sequence. It must be :\n- at least 5us\n- no more than 100us"]
    #[inline(always)]
    pub fn otpc_tim2_us_t_ppr(
        self,
    ) -> crate::common::RegisterField<8, 0x7f, 1, 0, u8, OtpcTim2Reg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<8,0x7f,1,0,u8, OtpcTim2Reg_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "The number of microseconds (minus one) between two consecutive programming pulses. It must be :\n- at least 1us\n- no more than 5us"]
    #[inline(always)]
    pub fn otpc_tim2_us_t_pwi(
        self,
    ) -> crate::common::RegisterField<5, 0x7, 1, 0, u8, OtpcTim2Reg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<5,0x7,1,0,u8, OtpcTim2Reg_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "The number of microseconds (minus one) that lasts the programming of each bit. It must be :\n- at least 10us\n- no more than 20us"]
    #[inline(always)]
    pub fn otpc_tim2_us_t_pw(
        self,
    ) -> crate::common::RegisterField<0, 0x1f, 1, 0, u8, OtpcTim2Reg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0x1f,1,0,u8, OtpcTim2Reg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
