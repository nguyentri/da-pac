...
impl BleTimerReg {
    ...
    pub fn ble_timer_data(
        self,
    ) -> crate::common::RegisterField<0, 0x3ff, 1, 0, u16, BleTimerReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0x3ff,1,0,u16, BleTimerReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl GpControlReg {
    ...
    pub fn ble_timer_data_ctrl(
        self,
    ) -> crate::common::RegisterField<5, 0x3, 1, 0, u8, GpControlReg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<5,0x3,1,0,u8, GpControlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
...
impl MemCtrlReg {
    ...
    pub fn ram_margin(
        self,
    ) -> crate::common::RegisterField<6, 0x3, 1, 0, u8, MemCtrlReg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<6,0x3,1,0,u8, MemCtrlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = ""]
    #[inline(always)]
    pub fn ram_dst(
    ...
    pub fn rom_margin_ctrl(
        self,
    ) -> crate::common::RegisterField<0, 0xf, 1, 0, u8, MemCtrlReg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0xf,1,0,u8, MemCtrlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
