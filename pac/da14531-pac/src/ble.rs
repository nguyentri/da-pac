...
impl BleCntl2Reg {
    ...
    #[doc = "When cleared to \"0\" then it masks the BLE_ARP_ERR_STAT in order to not trigger a BLE_ERROR_IRQ."]
    #[inline(always)]
...
impl BleDeepslcntlReg {
    ...
    #[doc = "Wake Up Request from BLE Software. Applies when system is in Deep Sleep Mode. It wakes up the BLE Core when written with a 1. Resets at 0 when action is performed. No action happens if it is written with 0."]
    #[inline(always)]
...
impl BleErrortypestatReg {
    #[doc = "Indicates whether two consecutive and concurrent ble_event_irq have been generated, and not acknowledged in time by the BLE Software.\n0: No error\n1: Error occurred"]
    #[inline(always)]
...
impl BleFinetimtgtReg {
    #[doc = "Fine Timer Target value on which a ble_finetgtim_irq must be generated. This timer has a precision of 625 usec: interrupt is generated only when FINETARGET = BASETIMECNT"]
    #[inline(always)]
    pub fn finetarget(
        self,
    ) -> crate::common::RegisterField<
...
impl BleRadiopwrupdnReg {
    #[doc = "Defines round trip delay value. This value correspond to the addition of data latency in Tx and data latency in Rx. Value is in usec."]
    #[inline(always)]
    pub fn rtrip_delay(
        self,
    ) -> crate::common::RegisterField<
    ...
    #[doc = "This register holds the length in s of the RX power up phase for the current radio device. Default value is 210 usec (reset value). Operating range depends on the selected radio."]
    #[inline(always)]
    pub fn rxpwrup(
        self,
    ) -> crate::common::RegisterField<
    ...
    #[doc = "This register extends the length in s of the TX power down phase for the current radio device. Default value is 3 usec (reset value). Operating range depends on the selected radio."]
    #[inline(always)]
    pub fn txpwrdn(
        self,
    ) -> crate::common::RegisterField<
    ...
    #[doc = "This register holds the length in s of the TX power up phase for the current radio device. Default value is 210 usec (reset value). Operating range depends on the selected radio."]
    #[inline(always)]
    pub fn txpwrup(
        self,
    ) -> crate::common::RegisterField<
...
impl BleRftestcntlReg {
    ...
    #[doc = "Applicable only for Tx/Rx RF Test mode, and valid when BLE_RFTESTCNTL_REG\\[TXLENGTHSRC\\] = 1\nTx packet length in number of byte"]
    #[inline(always)]
    pub fn txlength(
        self,
    ) -> crate::common::RegisterField<
...
impl BleTimgencntlReg {
    ...
    #[doc = "Defines the instant in usec at which immediate abort is required after anticipated pre-fetch abort."]
    #[inline(always)]
