...
impl Wkup2PolGpioReg {
    ...
    pub fn wkup2_pol_gpio(
        self,
    ) -> crate::common::RegisterField<0, 0xfff, 1, 0, u16, Wkup2PolGpioReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0xfff,1,0,u16, Wkup2PolGpioReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl Wkup2SelectGpioReg {
    ...
    pub fn wkup2_select_gpio(
        self,
    ) -> crate::common::RegisterField<0, 0xfff, 1, 0, u16, Wkup2SelectGpioReg_SPEC, crate::common::RW>
    {
...
impl WkupCounterReg {
    ...
    pub fn event2_value(
        self,
    ) -> crate::common::RegisterField<8, 0xff, 1, 0, u8, WkupCounterReg_SPEC, crate::common::R>
    {
        crate::common::RegisterField::<8,0xff,1,0,u8, WkupCounterReg_SPEC,crate::common::R>::from_register(self,0)
    }
    #[doc = "This value represents the number of events that have been counted so far. It will be reset by resetting the interrupt."]
    #[inline(always)]
    pub fn event_value(
...
impl WkupPolGpioReg {
    ...
    pub fn wkup_pol_gpio(
        self,
    ) -> crate::common::RegisterField<0, 0xfff, 1, 0, u16, WkupPolGpioReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0xfff,1,0,u16, WkupPolGpioReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl WkupSelectGpioReg {
    ...
    pub fn wkup_select_gpio(
        self,
    ) -> crate::common::RegisterField<0, 0xfff, 1, 0, u16, WkupSelectGpioReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0xfff,1,0,u16, WkupSelectGpioReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
