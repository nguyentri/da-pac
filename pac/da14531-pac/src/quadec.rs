...
impl QdecCtrl2Reg {
    ...
    pub fn qdec_chz_port_sel(
        self,
    ) -> crate::common::RegisterField<6, 0x7, 1, 0, u8, QdecCtrl2Reg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<6,0x7,1,0,u8, QdecCtrl2Reg_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn qdec_chy_port_sel(
        self,
    ) -> crate::common::RegisterField<3, 0x7, 1, 0, u8, QdecCtrl2Reg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<3,0x7,1,0,u8, QdecCtrl2Reg_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn qdec_chx_port_sel(
        self,
    ) -> crate::common::RegisterField<0, 0x7, 1, 0, u8, QdecCtrl2Reg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0x7,1,0,u8, QdecCtrl2Reg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl QdecCtrlReg {
    ...
    pub fn qdec_irq_thres(
        self,
    ) -> crate::common::RegisterField<3, 0xff, 1, 0, u8, QdecCtrlReg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<3,0xff,1,0,u8, QdecCtrlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
...
impl QdecEventCntReg {
    ...
    pub fn qdec_event_cnt(
        self,
    ) -> crate::common::RegisterField<0, 0xff, 1, 0, u8, QdecEventCntReg_SPEC, crate::common::R>
    {
        crate::common::RegisterField::<0,0xff,1,0,u8, QdecEventCntReg_SPEC,crate::common::R>::from_register(self,0)
    }
}
