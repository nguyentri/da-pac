...
impl GpAdcCtrl2Reg {
    ...
    pub fn gp_adc_offs_sh_cm(
        self,
    ) -> crate::common::RegisterField<4, 0x3, 1, 0, u8, u8, GpAdcCtrl2Reg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<4,0x3,1,0,u8,u8,GpAdcCtrl2Reg_SPEC,crate::common::RW>::from_register(self,0)
    }
...
impl GpAdcTrimReg {
    ...
    pub fn gp_adc_ldo_level(
        self,
    ) -> crate::common::RegisterField<4, 0x7, 1, 0, u8, u8, GpAdcTrimReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<4,0x7,1,0,u8,u8,GpAdcTrimReg_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn gp_adc_offs_sh_vref(
        self,
    ) -> crate::common::RegisterField<0, 0xf, 1, 0, u8, u8, GpAdcTrimReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0xf,1,0,u8,u8,GpAdcTrimReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
