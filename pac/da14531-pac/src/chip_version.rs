...
impl ::core::default::Default for ChipId2Reg {
    ...
    fn default() -> ChipId2Reg {
        <crate::RegValueT<ChipId2Reg_SPEC> as RegisterValue<_>>::new(54)
    }
}
...
impl ::core::default::Default for ChipId3Reg {
    ...
    fn default() -> ChipId3Reg {
        <crate::RegValueT<ChipId3Reg_SPEC> as RegisterValue<_>>::new(51)
    }
}
...
impl ChipId4Reg {
    ...
    pub fn chip_id4(
        self,
    ) -> crate::common::RegisterField<0, 0xff, 1, 0, u8, ChipId4Reg_SPEC, crate::common::R> {
        crate::common::RegisterField::<0,0xff,1,0,u8, ChipId4Reg_SPEC,crate::common::R>::from_register(self,0)
    }
}
...
impl ChipTest1Reg {
    ...
    pub fn chip_layout_revision(
        self,
    ) -> crate::common::RegisterField<0, 0xff, 1, 0, u8, ChipTest1Reg_SPEC, crate::common::R> {
        crate::common::RegisterField::<0,0xff,1,0,u8, ChipTest1Reg_SPEC,crate::common::R>::from_register(self,0)
    }
}
impl ::core::default::Default for ChipTest1Reg {
    #[inline(always)]
    fn default() -> ChipTest1Reg {
        <crate::RegValueT<ChipTest1Reg_SPEC> as RegisterValue<_>>::new(65)
    }
}
...
impl ChipTest2Reg {
    ...
    pub fn chip_metal_option(
        self,
    ) -> crate::common::RegisterField<0, 0xf, 1, 0, u8, ChipTest2Reg_SPEC, crate::common::R> {
        crate::common::RegisterField::<0,0xf,1,0,u8, ChipTest2Reg_SPEC,crate::common::R>::from_register(self,0)
    }
}
