...
impl super::Spi {
    ...
    #[inline(always)]
    pub const fn spi_rx_tx_reg(
        &self,
    ) -> &'static crate::common::Reg<self::SpiRxTxReg_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::SpiRxTxReg_SPEC, crate::common::RW>::from_ptr(
...
impl SpiClearIntReg {
    ...
    pub fn spi_clear_int(
        self,
    ) -> crate::common::RegisterField<0, 0xffffffff, 1, 0, u32, SpiClearIntReg_SPEC, crate::common::W>
    {
...
impl SpiCtrlReg {
    ...
    pub fn spi_tx_fifo_notfull_mask(
        self,
    ) -> crate::common::RegisterFieldBool<25, 1, 0, SpiCtrlReg_SPEC, crate::common::RW> {
        crate::common::RegisterFieldBool::<25,1,0,SpiCtrlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn spi_dma_txreq_mode(
        self,
    ) -> crate::common::RegisterFieldBool<24, 1, 0, SpiCtrlReg_SPEC, crate::common::RW> {
        crate::common::RegisterFieldBool::<24,1,0,SpiCtrlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "0 = Trasmit fifo is not empty\n1 = Trasmit fifo is empty"]
    #[inline(always)]
    pub fn spi_tx_fifo_empty(
        self,
    ) -> crate::common::RegisterFieldBool<23, 1, 0, SpiCtrlReg_SPEC, crate::common::R> {
        crate::common::RegisterFieldBool::<23,1,0,SpiCtrlReg_SPEC,crate::common::R>::from_register(self,0)
    }
    #[doc = "0 = Receive fifo is not full\n1 = Receive fifo is full"]
    #[inline(always)]
    pub fn spi_rx_fifo_full(
        self,
    ) -> crate::common::RegisterFieldBool<22, 1, 0, SpiCtrlReg_SPEC, crate::common::R> {
        crate::common::RegisterFieldBool::<22,1,0,SpiCtrlReg_SPEC,crate::common::R>::from_register(self,0)
    }
    #[doc = "0 = Receive fifo is not empty\n1 = Receive fifo is empty"]
    #[inline(always)]
    pub fn spi_rx_fifo_empty(
        self,
    ) -> crate::common::RegisterFieldBool<21, 1, 0, SpiCtrlReg_SPEC, crate::common::R> {
        crate::common::RegisterFieldBool::<21,1,0,SpiCtrlReg_SPEC,crate::common::R>::from_register(self,0)
    }
    #[doc = "Determines the value of the first bit in 9 bits SPI mode."]
    #[inline(always)]
    pub fn spi_9bit_val(
        self,
    ) -> crate::common::RegisterFieldBool<20, 1, 0, SpiCtrlReg_SPEC, crate::common::RW> {
        crate::common::RegisterFieldBool::<20,1,0,SpiCtrlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn spi_busy(
        self,
    ) -> crate::common::RegisterFieldBool<19, 1, 0, SpiCtrlReg_SPEC, crate::common::R> {
        crate::common::RegisterFieldBool::<19,1,0,SpiCtrlReg_SPEC,crate::common::R>::from_register(self,0)
    }
    ...
    pub fn spi_priority(
        self,
    ) -> crate::common::RegisterFieldBool<18, 1, 0, SpiCtrlReg_SPEC, crate::common::RW> {
        crate::common::RegisterFieldBool::<18,1,0,SpiCtrlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn spi_fifo_mode(
        self,
    ) -> crate::common::RegisterField<16, 0x3, 1, 0, u8, SpiCtrlReg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<16,0x3,1,0,u8, SpiCtrlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn spi_word(
        self,
    ) -> crate::common::RegisterField<8, 0x3, 1, 0, u8, SpiCtrlReg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<8,0x3,1,0,u8, SpiCtrlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn spi_clk(
        self,
    ) -> crate::common::RegisterField<3, 0x3, 1, 0, u8, SpiCtrlReg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<3,0x3,1,0,u8, SpiCtrlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
...
impl ::core::default::Default for SpiCtrlReg {
    ...
    fn default() -> SpiCtrlReg {
        <crate::RegValueT<SpiCtrlReg_SPEC> as RegisterValue<_>>::new(10682368)
    }
}

#[doc(hidden)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct SpiRxTxReg_SPEC;
impl crate::sealed::RegSpec for SpiRxTxReg_SPEC {
    type DataType = u32;
}
#[doc = "SPI RX/TX register0"]
pub type SpiRxTxReg = crate::RegValueT<SpiRxTxReg_SPEC>;
...
impl SpiRxTxReg {
    ...
    pub fn spi_data(
        self,
    ) -> crate::common::RegisterField<0, 0xffffffff, 1, 0, u32, SpiRxTxReg_SPEC, crate::common::W>
    {
        crate::common::RegisterField::<0,0xffffffff,1,0,u32, SpiRxTxReg_SPEC,crate::common::W>::from_register(self,0)
    }
}
impl ::core::default::Default for SpiRxTxReg {
    #[inline(always)]
    fn default() -> SpiRxTxReg {
        <crate::RegValueT<SpiRxTxReg_SPEC> as RegisterValue<_>>::new(0)
    }
}
