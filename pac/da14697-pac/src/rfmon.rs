...
impl RfmonAddrReg {
    ...
    pub fn rfmon_addr(
        self,
    ) -> crate::common::RegisterField<2, 0x3fffffff, 1, 0, u32, RfmonAddrReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<2,0x3fffffff,1,0,u32, RfmonAddrReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl RfmonCrvLenReg {
    ...
    pub fn rfmon_crv_len(
        self,
    ) -> crate::common::RegisterField<0, 0x1ffff, 1, 0, u32, RfmonCrvLenReg_SPEC, crate::common::R>
    {
        crate::common::RegisterField::<0,0x1ffff,1,0,u32, RfmonCrvLenReg_SPEC,crate::common::R>::from_register(self,0)
    }
}
...
impl RfmonLenReg {
    ...
    pub fn rfmon_len(
        self,
    ) -> crate::common::RegisterField<0, 0x1ffff, 1, 0, u32, RfmonLenReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0x1ffff,1,0,u32, RfmonLenReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
