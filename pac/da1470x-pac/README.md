...
This is the Peripheral Access Crate (PAC) for the DA1470X device series.
...
The `da1470x-pac` crate provides low-level access to device registers, enabling developers to interact with the hardware safely and efficiently.
