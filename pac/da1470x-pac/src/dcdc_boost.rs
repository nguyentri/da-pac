...
impl BoostCtrlReg0 {
    ...
    pub fn boost_timeout_trig_delay(
        self,
    ) -> crate::common::RegisterField<17, 0xf, 1, 0, u8, BoostCtrlReg0_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<17,0xf,1,0,u8, BoostCtrlReg0_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn boost_psw_timeout(
        self,
    ) -> crate::common::RegisterField<13, 0xf, 1, 0, u8, BoostCtrlReg0_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<13,0xf,1,0,u8, BoostCtrlReg0_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn boost_nsw_timeout(
        self,
    ) -> crate::common::RegisterField<9, 0xf, 1, 0, u8, BoostCtrlReg0_SPEC, crate::common::RW> {
        crate::common::RegisterField::<9,0xf,1,0,u8, BoostCtrlReg0_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Number of subsequent V_NOK events before BOOST_VLED_OK is reset\n0x0: 2\n0x1: 4\n0x2: 8 (default)\n0x3: 15"]
    #[inline(always)]
    pub fn boost_ok_clr_count(
        self,
    ) -> crate::common::RegisterField<7, 0x3, 1, 0, u8, BoostCtrlReg0_SPEC, crate::common::RW> {
        crate::common::RegisterField::<7,0x3,1,0,u8, BoostCtrlReg0_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Determines times between comparator samples when converter is idle\n0x0 = 250 ns\n0x1 = 500 ns (default)\n0x2 = 1000 ns\n0x3 = 2000 ns"]
    #[inline(always)]
    pub fn boost_idle_clk_div(
        self,
    ) -> crate::common::RegisterField<5, 0x3, 1, 0, u8, BoostCtrlReg0_SPEC, crate::common::RW> {
        crate::common::RegisterField::<5,0x3,1,0,u8, BoostCtrlReg0_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Trim setting for boost converter, sets deviation from nominal output voltage (4 V)\n0x0: -75 mV\n0x1: -50 mV\n0x2: -25 mV\n0x3: 0 mV (default)\n0x4: 25 mV\n0x5: 50 mV\n0x6: 75 mV\n0x7: 100 mV"]
    #[inline(always)]
    pub fn boost_vled_trim(
        self,
    ) -> crate::common::RegisterField<2, 0x7, 1, 0, u8, BoostCtrlReg0_SPEC, crate::common::RW> {
        crate::common::RegisterField::<2,0x7,1,0,u8, BoostCtrlReg0_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Voltage selection for boost converter, sets nominal output voltage\n0x0: 4.50V (default)\n0x1: 4.75V\n0x2: 5.00V\n0x3: 5.00V"]
    #[inline(always)]
    pub fn boost_vled_sel(
        self,
    ) -> crate::common::RegisterField<0, 0x3, 1, 0, u8, BoostCtrlReg0_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0x3,1,0,u8, BoostCtrlReg0_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl BoostCtrlReg1 {
    ...
    pub fn boost_cur_lim_sleep(
        self,
    ) -> crate::common::RegisterField<12, 0x1f, 1, 0, u8, BoostCtrlReg1_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<12,0x1f,1,0,u8, BoostCtrlReg1_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Step size taken by automatic inductor peak current limit control\n0x0: 0 (disabled)\n0x1: 1\n0x2: 2 (default)\n0x3: 3"]
    #[inline(always)]
    pub fn boost_cur_lim_step(
        self,
    ) -> crate::common::RegisterField<10, 0x3, 1, 0, u8, BoostCtrlReg1_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<10,0x3,1,0,u8, BoostCtrlReg1_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Maximum inductor peak current limit\nI = 30 mA * (1 + N), default 960 mA"]
    #[inline(always)]
    pub fn boost_cur_lim_max(
        self,
    ) -> crate::common::RegisterField<5, 0x1f, 1, 0, u8, BoostCtrlReg1_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<5,0x1f,1,0,u8, BoostCtrlReg1_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Minimum inductor peak current limit\nI = 30 mA * (1 + N), default 150 mA"]
    #[inline(always)]
    pub fn boost_cur_lim_min(
        self,
    ) -> crate::common::RegisterField<0, 0x1f, 1, 0, u8, BoostCtrlReg1_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0x1f,1,0,u8, BoostCtrlReg1_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl BoostStatusReg {
    ...
    pub fn boost_comp_trim(
        self,
    ) -> crate::common::RegisterField<18, 0x3f, 1, 0, u8, BoostStatusReg_SPEC, crate::common::R>
    {
        crate::common::RegisterField::<18,0x3f,1,0,u8, BoostStatusReg_SPEC,crate::common::R>::from_register(self,0)
    }
    #[doc = "Converter idle"]
    #[inline(always)]
    pub fn boost_idle(
    ...
    pub fn boost_cur_lim(
        self,
    ) -> crate::common::RegisterField<12, 0x1f, 1, 0, u8, BoostStatusReg_SPEC, crate::common::R>
    {
        crate::common::RegisterField::<12,0x1f,1,0,u8, BoostStatusReg_SPEC,crate::common::R>::from_register(self,0)
    }
    ...
    pub fn boost_sw_state(
        self,
    ) -> crate::common::RegisterField<2, 0x3, 1, 0, u8, BoostStatusReg_SPEC, crate::common::R> {
        crate::common::RegisterField::<2,0x3,1,0,u8, BoostStatusReg_SPEC,crate::common::R>::from_register(self,0)
    }
...
impl BoostTestCtrlReg {
    ...
    pub fn boost_iload_sel_test(
        self,
    ) -> crate::common::RegisterField<27, 0x3, 1, 0, u8, BoostTestCtrlReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<27,0x3,1,0,u8, BoostTestCtrlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Trim low side supply voltage\nV = 2 V + 300 mV * N, default 2.9 V"]
    #[inline(always)]
    pub fn boost_lssup_trim(
        self,
    ) -> crate::common::RegisterField<22, 0x3, 1, 0, u8, BoostTestCtrlReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<22,0x3,1,0,u8, BoostTestCtrlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Trim high side ground\nV = VBAT - (2 V + 400 mV * N), default VBAT - 3.2 V"]
    #[inline(always)]
    pub fn boost_hsgnd_trim(
        self,
    ) -> crate::common::RegisterField<20, 0x3, 1, 0, u8, BoostTestCtrlReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<20,0x3,1,0,u8, BoostTestCtrlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl VledPwrCtrlReg {
    ...
    pub fn vled_pwr_force(
        self,
    ) -> crate::common::RegisterField<11, 0x3, 1, 0, u8, VledPwrCtrlReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<11,0x3,1,0,u8, VledPwrCtrlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn vsys_ok_debounce(
        self,
    ) -> crate::common::RegisterField<0, 0xff, 1, 0, u8, VledPwrCtrlReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0xff,1,0,u8, VledPwrCtrlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl VledPwrStatusReg {
    ...
    pub fn vled_pwr_switch_ctrl_state(
        self,
    ) -> crate::common::RegisterField<2, 0x3, 1, 0, u8, VledPwrStatusReg_SPEC, crate::common::R>
    {
        crate::common::RegisterField::<2,0x3,1,0,u8, VledPwrStatusReg_SPEC,crate::common::R>::from_register(self,0)
    }
