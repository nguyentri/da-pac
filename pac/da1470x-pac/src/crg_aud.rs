...
#[allow(unused_imports)]
use crate::common::*;
#[doc = r"CRG_AUD registers"]
unsafe impl ::core::marker::Send for super::CrgAud {}
unsafe impl ::core::marker::Sync for super::CrgAud {}
impl super::CrgAud {
    #[allow(unused)]
    #[inline(always)]
...
impl SrcDivReg {
    #[doc = "Enable for the internally generated SRC2 clock\nThe SRC2_DIV must be set before or together with CLK_SRC2_EN."]
    #[inline(always)]
    pub fn clk_src2_en(
        self,
    ) -> crate::common::RegisterFieldBool<17, 1, 0, SrcDivReg_SPEC, crate::common::RW> {
        crate::common::RegisterFieldBool::<17,1,0,SrcDivReg_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn clk_src_en(
        self,
    ) -> crate::common::RegisterFieldBool<16, 1, 0, SrcDivReg_SPEC, crate::common::RW> {
        crate::common::RegisterFieldBool::<16,1,0,SrcDivReg_SPEC,crate::common::RW>::from_register(self,0)
    }

    #[doc = "SRC2 clock divider"]
    #[inline(always)]
    pub fn src2_div(
        self,
    ) -> crate::common::RegisterField<8, 0xff, 1, 0, u8, u8, SrcDivReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<8,0xff,1,0,u8,u8,SrcDivReg_SPEC,crate::common::RW>::from_register(self,0)
    }
