...
impl SrcDivReg {
    ...
    pub fn src2_div(
        self,
    ) -> crate::common::RegisterField<8, 0xff, 1, 0, u8, SrcDivReg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<8,0xff,1,0,u8, SrcDivReg_SPEC,crate::common::RW>::from_register(self,0)
    }
