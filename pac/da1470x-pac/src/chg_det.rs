...
impl ChgDetDcdTimerReg {
    ...
    pub fn dcd_timer(
        self,
    ) -> crate::common::RegisterField<16, 0x3ff, 1, 0, u16, ChgDetDcdTimerReg_SPEC, crate::common::R>
    {
        crate::common::RegisterField::<16,0x3ff,1,0,u16, ChgDetDcdTimerReg_SPEC,crate::common::R>::from_register(self,0)
    }
    ...
    pub fn dcd_timeout_thres(
        self,
    ) -> crate::common::RegisterField<0, 0x3ff, 1, 0, u16, ChgDetDcdTimerReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0x3ff,1,0,u16, ChgDetDcdTimerReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl ChgDetFsmStatusReg {
    ...
    pub fn chg_det_state(
        self,
    ) -> crate::common::RegisterField<9, 0xf, 1, 0, u8, ChgDetFsmStatusReg_SPEC, crate::common::R>
    {
        crate::common::RegisterField::<9,0xf,1,0,u8, ChgDetFsmStatusReg_SPEC,crate::common::R>::from_register(self,0)
    }
...
impl ChgDetTimerReg {
    ...
    pub fn chg_det_timer(
        self,
    ) -> crate::common::RegisterField<16, 0xff, 1, 0, u8, ChgDetTimerReg_SPEC, crate::common::R>
    {
        crate::common::RegisterField::<16,0xff,1,0,u8, ChgDetTimerReg_SPEC,crate::common::R>::from_register(self,0)
    }
    ...
    pub fn chg_det_timer_thres(
        self,
    ) -> crate::common::RegisterField<0, 0xff, 1, 0, u8, ChgDetTimerReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0xff,1,0,u8, ChgDetTimerReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
