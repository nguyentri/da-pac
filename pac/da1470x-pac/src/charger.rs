...
impl super::Charger {
    ...
    #[doc = "Charger current status register"]
    #[inline(always)]
    ...
    #[doc = "JEITA-compliant current settings register for \"Cooler\" and \"Warmer\" zones"]
    #[inline(always)]
    ...
    #[doc = "Charger power-up settling timer register"]
    #[inline(always)]
    ...
    #[doc = "Battery temperature (main) comparator timer register"]
    #[inline(always)]
    ...
    #[doc = "Battery temperature monitor interval timer register"]
    #[inline(always)]
    ...
    #[doc = "Charger battery temperature settings register (Cooler, Warmer)."]
    #[inline(always)]
    ...
    #[doc = "Battery temperature comparator timer register for \"Hot\" zone"]
    #[inline(always)]
    ...
    #[doc = "Charger voltage status register"]
    #[inline(always)]
...
impl ChargerCtrlReg {
    #[doc = "0 = Edge-sensitive End-of-Charge detection support is enabled (default). The Charger\'s digital block expects a positive edge of the End-of-Charge signal coming from the Charger\'s analog circuit to let the respective debounce counters start and enable the FSM switch to the END_OF_CHARGE state, if the signal is stable.\n1 = Level-sensitive End-of-Charge detection is enabled. In this mode, the Charger\'s digital block only monitors the level of the End-of-Charge signal coming from the analog circuit and if this is seen high in either CC_CHARGE or CV_CHARGE state, the EOC debounce counters start."]
    #[inline(always)]
    pub fn eoc_trigger(
        self,
    ...
    #[doc = "0 = Charger\'s Pre-Charge, CC, CV and Total charge timeout timers are ticking properly, running at the 1Hz clock.\n1 = All four Charger\'s timeout timers are halted, counting is disabled. The counters will be reset when the FSM is either in DISABLED or in END_OF_CHARGE state.\nNote: Value \'0\' is the recommended, \'1\' is a test mode, since it will globally halt the four timers and thus will block the generation of the respective timer expiration IRQs."]
    #[inline(always)]
...
impl ChargerCurrentParamReg {
    #[doc = "When set, the specific bit-field enables an increase of the (%) range of End-of-Charge current setting. Consequently, the default lower and upper limits of 6% of I_CHARGE (value 0x0 of I_END_OF_CHARGE bit-field) and 20% (value 0x7 of the same bit-field) are increased to 12% and 40% respectively, as soon as the I_EOC_DOUBLE_RANGE bit-field is set."]
    #[inline(always)]
    ...
    #[doc = "End-of-Charge current setting, ranging from 6%(\"000\") to 20% (\"111\") of the charge current setting, with a step size of 2%, as follows (when I_EOC_DOUBLE_RANGE = 0):\n000 : 6%\n001 : 8%\n010 : 10%\n011 : 12%\n100 : 14%\n101 : 16%\n110 : 18%\n111 : 20%\nWhen I_EOC_DOUBLE_RANGE = 1, the range is:\n000 : 12%\n001 : 16%\n010 : 20%\n011 : 24%\n100 : 28%\n101 : 32%\n110 : 36%\n111 : 40%"]
    #[inline(always)]
    ...
    #[doc = "This bit-field determines the Pre-Charge current, in mA, ranging from 0.5 to 72mA, according to the following encoding:\n0   :  0.5 mA\n1   :  1  mA\n2   :  1.5mA\n3   :  2 mA\n4   :  2.5mA\n5   :  3  mA\n6   :  3.5mA\n7   :  4  mA\n8   :  4.5mA\n9   :  5  mA\n10 :  5.5mA\n11 :  6  mA\n12 :  6.5mA\n13 :  7  mA\n14 :  7.5mA\n15 :  8  mA\n16 :  9  mA\n17 : 10 mA\n18 : 11 mA\n19 : 12 mA\n20 : 13 mA\n21 : 14 mA\n22 : 15 mA\n23 : 16 mA\n24 : 17 mA\n25 : 18 mA\n26 : 19 mA\n27 : 20 mA\n28 : 21 mA\n29 : 22 mA\n30 : 23 mA\n31 : 24 mA\n32 : 27 mA\n33 : 30 mA\n34 : 33 mA\n35 : 36 mA\n36 : 39 mA\n37 : 42 mA\n38 : 45 mA\n39 : 48 mA\n40 : 51 mA\n41 : 54 mA\n42 : 57 mA\n43 : 60 mA\n44 : 63 mA\n45 : 66 mA\n46 : 69 mA\n47 : 72 mA\n48 : 72 mA\n49 : 72 mA\n50 : 72 mA\n51 : 72 mA\n52 : 72 mA\n53 : 72 mA\n54 : 72 mA\n55 : 72 mA\n56 : 72 mA\n57 : 72 mA\n58 : 72 mA\n59 : 72 mA\n60 : 72 mA\n61 : 72 mA\n62 : 72 mA\n63 : 72 mA"]
    #[inline(always)]
    pub fn i_precharge(
        self,
    ) -> crate::common::RegisterField<
...
impl ChargerCurrentStatusReg {
    ...
    #[doc = "This bit-field returns the applied CC current setting. In JEITA charging, it contains the value corresponding to the present battery temperature zone, according to CHARGER_JEITA_CURRENT/CURRENT2_REG. If JEITA charging is disabled, it reflects the value of I_CHARGE bit-field CHARGER_CURRENT_PARAM_REG.\nThe specific bit-field is updated by the battery monitoring (JEITA) FSM, as soon as the latter starts running. Until then, it reflects the corresponding bit-field of CHARGER_CURRENT_PARAM_REG."]
    #[inline(always)]
    pub fn i_charge_set(
        self,
    ) -> crate::common::RegisterField<
...
impl ChargerErrorIrqStatusReg {
    ...
    #[doc = "0 = No Die temperature error IRQ events have been captured, so charging may continue\n1 = A Die temperature error IRQ event is captured, declaring that the Charger\'s FSM has switched to the respective error state (TDIE_PROT) and charging will be automatically stopped.\nNote : The status bit is updated automatically when a Die temperature error is detected, thus when the die temperature is found to have exceeded the programmed level, regardless of the state of the respective IRQ mask bit. The same applies to all the other status bits of the specific register."]
    #[inline(always)]
...
impl ChargerJeitaCurrent2Reg {
    #[doc = "Pre-charge current settings bit-field for the \"WARMER\" battery temperature pack zone. Regarding the range of values of this bit-field, see also the description of I_PRECHARGE field of CHARGER_CURRENT_PARAM_REG register."]
    #[inline(always)]
    ...
    #[doc = "Pre-charge current settings bit-field for the \"COOLER\" battery temperature pack zone. Regarding the range of values of this bit-field, see also the description of I_PRECHARGE field of CHARGER_CURRENT_PARAM_REG register."]
    #[inline(always)]
    ...
    #[doc = "Charge current settings bit-field for the \"WARMER\" battery temperature pack zone. Regarding the range of values of this bit-field, see also the description of I_CHARGE field of CHARGER_CURRENT_PARAM_REG register."]
    #[inline(always)]
    ...
    #[doc = "Charge current settings bit-field for the \"COOLER\" battery temperature pack zone. Regarding the range of values of this bit-field, see also the description of I_CHARGE field of CHARGER_CURRENT_PARAM_REG register."]
    #[inline(always)]
...
impl ChargerJeitaVChargeReg {
    #[doc = "Charge voltage setting for the Warmer battery temperature zone. Regarding the range of values of this bit-field, see also the description of V_CHARGE field of CHARGER_VOLTAGE_PARAM_REG register."]
    #[inline(always)]
    ...
    #[doc = "Charge voltage setting for the Cooler battery temperature zone. Regarding the range of values of this bit-field, see also the description of V_CHARGE field of CHARGER_VOLTAGE_PARAM_REG register."]
    #[inline(always)]
...
impl ChargerJeitaVOvpReg {
    #[doc = "VBAT Over-voltage Protection (OVP) setting for the Warmer battery temperature zone.Regarding the range of values of this bit-field, see also the description of V_CHARGE field of CHARGER_VOLTAGE_PARAM_REG."]
    #[inline(always)]
    pub fn v_ovp_twarmer(
        self,
    ) -> crate::common::RegisterField<18, 0x3f, 1, 0, u8, ChargerJeitaVOvpReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<
            18,
            0x3f,
    ...
    #[doc = "VBAT Over-voltage Protection (OVP) setting for the Cooler battery temperature zone.Regarding the range of values of this bit-field, see also the description of V_CHARGE field of CHARGER_VOLTAGE_PARAM_REG."]
    #[inline(always)]
    pub fn v_ovp_tcooler(
        self,
    ) -> crate::common::RegisterField<12, 0x3f, 1, 0, u8, ChargerJeitaVOvpReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<
            12,
            0x3f,
...
impl ChargerJeitaVPrechargeReg {
    #[doc = "Pre-Charge voltage setting for the Warmer battery temperature zone. Regarding the range of values of this bit-field, see also the description of V_CHARGE field of CHARGER_VOLTAGE_PARAM_REG register."]
    #[inline(always)]
    ...
    #[doc = "Pre-Charge voltage setting for the Cooler battery temperature zone. Regarding the range of values of this bit-field, see also the description of V_CHARGE field of CHARGER_VOLTAGE_PARAM_REG register."]
    #[inline(always)]
...
impl ChargerJeitaVReplenishReg {
    #[doc = "Replenish voltage setting for the Warmer battery temperature zone. Regarding the range of values of this bit-field, see also the description of V_CHARGE field of CHARGER_VOLTAGE_PARAM_REG."]
    #[inline(always)]
    ...
    #[doc = "Replenish voltage setting for the Cooler battery temperature zone. Regarding the range of values of this bit-field, see also the description of V_CHARGE field of CHARGER_VOLTAGE_PARAM_REG."]
    #[inline(always)]
...
impl ChargerLockReg {
    #[doc = "0 = SW-based protection of Charger registers is disabled, protection is dependent on the value of bits \\[14:0\\]\n1 = SW-based protection of Charger registers is active. Thus, if any of the 15 lock bits is non-set, the respective Charger register can be locked and back un-locked for writing, if the proper lock/un-lock sequence of writes is issued to CHARGER_SWLOCK_REG."]
    #[inline(always)]
    ...
    #[doc = "0 = CHARGER_JEITA_CURRENT2_REG is un-locked, register writes are allowed\n1 = CHARGER_JEITA_CURRENT2_REG is locked, register writes are not allowed"]
    #[inline(always)]
    ...
    #[doc = "0 = CHARGER_JEITA_CURRENT_REG is un-locked, register writes are allowed\n1 = CHARGER_JEITA_CURRENT_REG is locked, register writes are not allowed"]
    #[inline(always)]
    ...
    #[doc = "0 = CHARGER_JEITA_V_OVP_REG is un-locked, register writes are allowed\n1 = CHARGER_JEITA_V_OVP_REG is locked, register writes are not allowed"]
    #[inline(always)]
    ...
    #[doc = "0 = CHARGER_JEITA_V_PRECHARGE_REG is un-locked, register writes are allowed\n1 = CHARGER_JEITA_V_PRECHARGE_REG is locked, register writes are not allowed"]
    #[inline(always)]
    ...
    #[doc = "0 = CHARGER_JEITA_V_CHARGE_REG is un-locked, register writes are allowed\n1 = CHARGER_JEITA_V_CHARGE_REG is locked, register writes are not allowed"]
    #[inline(always)]
    ...
    #[doc = "0 = CHARGER_TOTAL_CHARGE_TIMER_REG is un-locked, register writes are allowed\n1 = CHARGER_TOTAL_CHARGE_TIMER_REG is locked, register writes are not allowed"]
    #[inline(always)]
    ...
    #[doc = "0 = CHARGER_CV_CHARGE_TIMER_REG is un-locked, register writes are allowed\n1 = CHARGER_CV_CHARGE_TIMER_REG is locked, register writes are not allowed"]
    #[inline(always)]
    ...
    #[doc = "0 = CHARGER_CC_CHARGE_TIMER_REG is un-locked, register writes are allowed\n1 = CHARGER_CC_CHARGE_TIMER_REG is locked, register writes are not allowed"]
    #[inline(always)]
    ...
    #[doc = "0 = CHARGER_PRE_CHARGE_TIMER_REG is un-locked, register writes are allowed\n1 = CHARGER_PRE_CHARGE_TIMER_REG is locked, register writes are not allowed"]
    #[inline(always)]
    ...
    #[doc = "0 = CHARGER_TEMPSET2_PARAM_REG is un-locked, register writes are allowed\n1 = CHARGER_TEMPSET2_PARAM_REG is locked, register writes are not allowed"]
    #[inline(always)]
    ...
    #[doc = "0 = CHARGER_TEMPSET_PARAM_REG is un-locked, register writes are allowed\n1 = CHARGER_TEMPSET_PARAM_REG is locked, register writes are not allowed"]
    #[inline(always)]
    ...
    #[doc = "0 = CHARGER_CURRENT_PARAM_REG is un-locked, writes are allowed\n1 = All bit-fields of the register are locked, writes are not allowed"]
    #[inline(always)]
    ...
    #[doc = "0 = CHARGER_VOLTAGE_PARAM_REG is un-locked, register writes are allowed\n1 = All bit-fields except of V_REPLENISH are locked, register writes to these bit-fields are not allowed"]
    #[inline(always)]
    ...
    #[doc = "0 = CHARGER_TEST_CTRL_REG is un-locked, register writes are allowed\n1 = CHARGER_TEST_CTRL_REG is locked, register writes are not allowed"]
    #[inline(always)]
...
impl ChargerPwrUpTimerReg {
    ...
    pub fn charger_pwr_up_timer(
        self,
    ) -> crate::common::RegisterField<16, 0x1f, 1, 0, u8, ChargerPwrUpTimerReg_SPEC, crate::common::R>
    {
        crate::common::RegisterField::<
            16,
            0x1f,
    ...
    pub fn charger_pwr_up_settling(
        self,
    ) -> crate::common::RegisterField<0, 0x1f, 1, 0, u8, ChargerPwrUpTimerReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<
            0,
            0x1f,
...
impl ChargerStatusReg {
    ...
    pub fn ovp_events_debounce_cnt(
        self,
    ) -> crate::common::RegisterField<26, 0x7, 1, 0, u8, ChargerStatusReg_SPEC, crate::common::R>
    {
        crate::common::RegisterField::<26,0x7,1,0,u8, ChargerStatusReg_SPEC,crate::common::R>::from_register(self,0)
    }
    ...
    pub fn eoc_events_debounce_cnt(
        self,
    ) -> crate::common::RegisterField<23, 0x7, 1, 0, u8, ChargerStatusReg_SPEC, crate::common::R>
    {
        crate::common::RegisterField::<23,0x7,1,0,u8, ChargerStatusReg_SPEC,crate::common::R>::from_register(self,0)
    }
    ...
    pub fn tdie_error_debounce_cnt(
        self,
    ) -> crate::common::RegisterField<20, 0x7, 1, 0, u8, ChargerStatusReg_SPEC, crate::common::R>
    {
        crate::common::RegisterField::<20,0x7,1,0,u8, ChargerStatusReg_SPEC,crate::common::R>::from_register(self,0)
    }
    ...
    pub fn charger_jeita_state(
        self,
    ) -> crate::common::RegisterField<16, 0xf, 1, 0, u8, ChargerStatusReg_SPEC, crate::common::R>
    {
        crate::common::RegisterField::<16,0xf,1,0,u8, ChargerStatusReg_SPEC,crate::common::R>::from_register(self,0)
    }
...
impl ChargerTempset2ParamReg {
    #[doc = "This bit-field determines the battery temperature threshold above which the \"WARMER\" zone is defined (between WARM and HOT). Regarding the temperatures supported, the range is between minus 10C and 53C, as already defined in the TBAT_COLD bit-field of CHARGER_TEMPSET_PARAM_REG."]
    #[inline(always)]
    pub fn tbat_warmer(
        self,
    ) -> crate::common::RegisterField<
...
impl ChargerVoltageStatusReg {
    #[doc = "This bit-field returns the applied V_OVP setting. In JEITA charging, it contains the value corresponding to the present battery temperature zone, according to JEITA_V_OVP_REG. If JEITA charging is disabled, it reflects the V_OVP bit-field of CHARGER_VOLTAGE_PARAM_REG.\nThe specific bit-field is updated by the battery monitoring (JEITA) FSM, as soon as the latter starts running. Until then, it reflects the corresponding bit-field of CHARGER_VOLTAGE_PARAM_REG."]
    #[inline(always)]
    pub fn v_ovp_set(
        self,
    ) -> crate::common::RegisterField<
    ...
    #[doc = "This bit-field returns the applied V_REPLENISH setting. In JEITA charging, it contains the value corresponding to the present battery temperature zone, according to JEITA_V_REPLENISH_REG. If JEITA charging is disabled, it reflects the V_REPLENISH bit-field of CHARGER_VOLTAGE_PARAM_REG.\nThe specific bit-field is updated by the battery monitoring (JEITA) FSM, as soon as the latter starts running. Until then, it reflects the corresponding bit-field of CHARGER_VOLTAGE_PARAM_REG."]
    #[inline(always)]
    ...
    #[doc = "This bit-field returns the applied V_PRECHARGE setting. In JEITA charging, it contains the value corresponding to the present battery temperature zone, according to JEITA_V_PRECHARGE_REG. If JEITA charging is disabled, it reflects the V_PRECHARGE bit-field of CHARGER_VOLTAGE_PARAM_REG.\nThe specific bit-field is updated by the battery monitoring (JEITA) FSM, as soon as the latter starts running. Until then, it reflects the corresponding bit-field of CHARGER_VOLTAGE_PARAM_REG."]
    #[inline(always)]
    ...
    #[doc = "This bit-field returns the applied V_CHARGE setting. In JEITA charging, it contains the value corresponding to the present battery temperature zone, according to JEITA_V_CHARGE_REG. If JEITA charging is disabled, it reflects the V_CHARGE bit-field of CHARGER_VOLTAGE_PARAM_REG.\nThe specific bit-field is updated by the battery monitoring (JEITA) FSM, as soon as the latter starts running. Until then, it reflects corresponding the bit-field of CHARGER_VOLTAGE_PARAM_REG."]
    #[inline(always)]
    pub fn v_charge_set(
        self,
    ) -> crate::common::RegisterField<
