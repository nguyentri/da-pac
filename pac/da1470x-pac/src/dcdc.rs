...
impl BuckCtrlReg {
    ...
    pub fn cfg_timeout(
        self,
    ) -> crate::common::RegisterField<14, 0x3, 1, 0, u8, BuckCtrlReg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<14,0x3,1,0,u8, BuckCtrlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn trim_bias(
        self,
    ) -> crate::common::RegisterField<10, 0x7, 1, 0, u8, BuckCtrlReg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<10,0x7,1,0,u8, BuckCtrlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Sets upper value of inductor peak current limit control.\n0x0: 260 mA\n0x1: 400 mA\n0x2: 530 mA\n0x3: 660 mA\n0x4: 790 mA\n0x5: 920 mA\n0x6: 1060 mA (Default)\n0x7: 1190 mA"]
    #[inline(always)]
    pub fn cfg_imax_upper(
        self,
    ) -> crate::common::RegisterField<5, 0x7, 1, 0, u8, BuckCtrlReg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<5,0x7,1,0,u8, BuckCtrlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Sets lower value of inductor peak current limit control.\n0x0: 260 mA (Default)\n0x1: 400 mA\n0x2: 530 mA\n0x3: 660 mA\n0x4: 790 mA\n0x5: 920 mA\n0x6: 1060 mA\n0x7: 1190 mA"]
    #[inline(always)]
    pub fn cfg_imax_lower(
        self,
    ) -> crate::common::RegisterField<2, 0x7, 1, 0, u8, BuckCtrlReg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<2,0x7,1,0,u8, BuckCtrlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
    #[doc = "Controls hysteresis on output comparator. Values listed are typical.\n0x0: 6 mV (Default)\n0x1: 9 mV\n0x2: 12 mV\n0x3: 15 mV"]
    #[inline(always)]
    pub fn cfg_hyst(
        self,
    ) -> crate::common::RegisterField<0, 0x3, 1, 0, u8, BuckCtrlReg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0x3,1,0,u8, BuckCtrlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
