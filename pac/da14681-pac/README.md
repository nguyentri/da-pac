...
This is the Peripheral Access Crate (PAC) for the DA14681 device series.
...
The `da14681-pac` crate provides low-level access to device registers, enabling developers to interact with the hardware safely and efficiently.
