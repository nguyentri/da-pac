...
impl CacheMrmHitsReg {
    ...
    pub fn mrm_hits(
        self,
    ) -> crate::common::RegisterField<0, 0x7ffff, 1, 0, u32, CacheMrmHitsReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0x7ffff,1,0,u32, CacheMrmHitsReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl CacheMrmThresReg {
    ...
    pub fn mrm_thres(
        self,
    ) -> crate::common::RegisterField<0, 0x3ffff, 1, 0, u32, CacheMrmThresReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<
            0,
            0x3ffff,
...
impl CacheMrmTintReg {
    ...
    pub fn mrm_tint(
        self,
    ) -> crate::common::RegisterField<0, 0x3ffff, 1, 0, u32, CacheMrmTintReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0x3ffff,1,0,u32, CacheMrmTintReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
