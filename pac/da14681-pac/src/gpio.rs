...
impl P2ResetDataReg {
    ...
    pub fn p2_reset(
        self,
    ) -> crate::common::RegisterField<0, 0x1f, 1, 0, u8, P2ResetDataReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0x1f,1,0,u8, P2ResetDataReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl P2SetDataReg {
    ...
    pub fn p2_set(
        self,
    ) -> crate::common::RegisterField<0, 0x1f, 1, 0, u8, P2SetDataReg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0x1f,1,0,u8, P2SetDataReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
