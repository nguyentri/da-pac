...
impl OtpcPaddrReg {
    ...
    pub fn otpc_paddr(
        self,
    ) -> crate::common::RegisterField<0, 0x3ff, 1, 0, u16, OtpcPaddrReg_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0x3ff,1,0,u16, OtpcPaddrReg_SPEC,crate::common::RW>::from_register(self,0)
    }
}
