...
impl Spi2CtrlReg {
    ...
    pub fn spi_fifo_mode(
        self,
    ) -> crate::common::RegisterField<16, 0x3, 1, 0, u8, Spi2CtrlReg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<16,0x3,1,0,u8, Spi2CtrlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
    ...
    pub fn spi_word(
        self,
    ) -> crate::common::RegisterField<8, 0x3, 1, 0, u8, Spi2CtrlReg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<8,0x3,1,0,u8, Spi2CtrlReg_SPEC,crate::common::RW>::from_register(self,0)
    }
...
impl Spi2RxTxReg {
    ...
    pub fn spi_data(
        self,
    ) -> crate::common::RegisterField<0, 0xffffffff, 1, 0, u32, Spi2RxTxReg_SPEC, crate::common::W>
    {
        crate::common::RegisterField::<0,0xffffffff,1,0,u32, Spi2RxTxReg_SPEC,crate::common::W>::from_register(self,0)
    }
}
