...
This is the Peripheral Access Crate (PAC) for the DA14691 device series.
...
The `da14691-pac` crate provides low-level access to device registers, enabling developers to interact with the hardware safely and efficiently.
