...
static REGISTER_NAMES: phf::Map<u64, &'static str> = phf_map! {
  ...
  0x5000003cu64 => "
    ...
    ",
  0x50000054u64 => "
      CRG_TOP.ldo_ctrl3_reg(),
    ",
  0x50000010u64 => "
      CRG_TOP.pmu_ctrl_reg(),
    ",
  0x50000068u64 => "
      CRG_TOP.pmu_reset_rail_reg(),
    ",
  0x50000042u64 => "
  ...
  0x40090094u64 => "
    ...
    ",
  0x40092000u64 => "
      FTDF.ftdf_long_addr_0_0_reg(),
    ",
  0x40092004u64 => "
      FTDF.ftdf_long_addr_1_0_reg(),
    ",
  0x40090038u64 => "
  ...
  0x40090480u64 => "
    ...
    ",
  0x40090364u64 => "
      FTDF.ftdf_wakeup_control_os_reg(),
    ",
  0x40091000u64 => "
  ...
  0x50000212u64 => "
    ...
    ",
  0x5000021eu64 => "
      TIMER_1.captim_capture_high_gpio1_reg(),
    ",
  0x50000220u64 => "
      TIMER_1.captim_capture_high_gpio2_reg(),
    ",
  0x50000200u64 => "
  ...
  0x50000216u64 => "
    ...
    ",
  0x5000021cu64 => "
      TIMER_1.captim_reload_high_reg(),
    ",
  0x5000020au64 => "
      TIMER_1.captim_reload_reg(),
    ",
  0x50000222u64 => "
      TIMER_1.captim_shotwidth_high_reg(),
    ",
  0x5000020cu64 => "
  ...
  0x50001802u64 => "
    ...
    ",
  0x50000124u64 => "
      WAKEUP.wkup_clear_0_reg(),
    ",
  0x50000126u64 => "
      WAKEUP.wkup_clear_1_reg(),
    ",
  0x50000128u64 => "
      WAKEUP.wkup_clear_2_reg(),
    ",
  0x50000100u64 => "
  ...
  0x5000012cu64 => "
    ...
    ",
  0x5000012eu64 => "
      WAKEUP.wkup_sel_gpio_p2_reg(),
    ",
  0x50000130u64 => "
      WAKEUP.wkup_sel_gpio_p3_reg(),
    ",
  0x50000132u64 => "
      WAKEUP.wkup_sel_gpio_p4_reg(),
    ",
  0x5000011eu64 => "
      WAKEUP.wkup_status_0_reg(),
    ",
  0x50000120u64 => "
      WAKEUP.wkup_status_1_reg(),
    ",
  0x50000122u64 => "
      WAKEUP.wkup_status_2_reg(),
    ",
  0x50003102u64 => "
