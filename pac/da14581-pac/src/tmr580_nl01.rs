...
impl Pwm2DutyCycle {
    ...
    pub fn duty_cycle(
        self,
    ) -> crate::common::RegisterField<0, 0x3fff, 1, 0, u16, Pwm2DutyCycle_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0x3fff,1,0,u16, Pwm2DutyCycle_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl Pwm3DutyCycle {
    ...
    pub fn duty_cycle(
        self,
    ) -> crate::common::RegisterField<0, 0x3fff, 1, 0, u16, Pwm3DutyCycle_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0x3fff,1,0,u16, Pwm3DutyCycle_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl Pwm4DutyCycle {
    ...
    pub fn duty_cycle(
        self,
    ) -> crate::common::RegisterField<0, 0x3fff, 1, 0, u16, Pwm4DutyCycle_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0x3fff,1,0,u16, Pwm4DutyCycle_SPEC,crate::common::RW>::from_register(self,0)
    }
}
